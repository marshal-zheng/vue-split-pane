...
// ASCII art logo
const logo = `
  SSSSS   PPPPP   L       IIIII  TTTTT    PPPPP   A    N   N   EEEEE
  S       P   P   L         I      T      P   P  A A   NN  N   E
  SSSSS   PPPPP   L         I      T      PPPPP AAAAA  N N N   EEEE
      S   P       L         I      T      P     A   A  N  NN   E
  SSSSS   P       LLLLL  IIIII    T      P     A   A  N   N   EEEEE
`;
...
async function generateDocs() {
  ...
  try {
    ...
    const libSource = path.join(__dirname, 'build', 'web', 'vue-split-pane.min.js');
    const libTarget = path.join(docsPath, 'vue-split-pane.min.js');
    ...
    htmlContent = htmlContent.replace(
      /<script id="vue-split-pane-script" src="[^"]*"><\/script>/g,
      '<script id="vue-split-pane-script" src="./vue-split-pane.min.js"></script>'
    );
